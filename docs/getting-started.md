...
Everything between installing the binary and a working two-way exchange. The
[README](../README.md) covers what amp-bridge is and the four-command setup; this
page is the long form of each step.
...
reports `status="pending"`; the request is already visible in the Amp thread and
